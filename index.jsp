...
<head>
    ...
    <title>BloodBond - Save Lives Through Blood Donation</title>
...
<body>
    ...
    <section class="hero" id="home">
        <div class="container">
            ...
            <p>Join our community of donars, hospitals, and recipients to create a reliable blood supply network. Your
                single donation can save up to three lives.</p>
            <a href="register.jsp" class="btn btn-hero">Become a Donar Today</a>
        </div>
    </section>
    ...
    <div class="container main-content">
        ...
        <section class="features-section">
            <h2 class="section-title">How BloodBond Works</h2>
            <div class="features-grid">
                <div class="feature-card">
                    ...
                    <h3>Register</h3>
                    <p>Create your profile with government ID verification to ensure authenticity and build trust.</p>
                </div>
                <div class="feature-card">
                    <div class="feature-icon">
                    ...
                    <p>Use our eligibility checker to ensure you meet all health requirements for donation.</p>
                </div>
                <div class="feature-card">
                    <div class="feature-icon">
                        <i class="fas fa-tint"></i>
                    ...
                    <h3>Donate Blood</h3>
                    <p>Visit a donation center or camp. Your donation is tracked in your profile.</p>
                </div>
                <div class="feature-card">
                    <div class="feature-icon">
                    ...
                    <h3>Earn Credits</h3>
                    <p>Receive credits for each donation that can be used in emergencies for you or family.</p>
                </div>
            </div>
        </section>
        ...
        <section class="stats-section">
            ...
            <div class="stats-grid">
                ...
                <div class="stat-card">
                    ...
                    <div class="stat-label">Active Donars</div>
                </div>
                <div class="stat-card">
        ...
        <section class="emergency-section">
            <div class="emergency-content">
                <div class="emergency-text">
                    ...
                    <p>Our emergency response team is available 24/7 to help you find the blood you need.</p>
                    <a href="find-blood.jsp" class="btn btn-emergency">
                        <i class="fas fa-phone-alt"></i> Emergency Blood Request
                    </a>
                </div>
