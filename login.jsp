        ...
        <div class="login-container">
            <div class="login-image">
                <div class="login-image-content">
                    ...
                    <h2>Welcome Back to PIEMR BloodBond</h2>
                    <p>This platform is exclusively for PIEMR students and faculty. Login with your college email to continue saving lives.</p>
                </div>
            </div>
            <div class="login-content">
                <div class="login-form">
                    <div class="login-header">
                        <h2>PIEMR Member Login</h2>
                    ...
                    <form id="loginForm" method="post">
                        <div class="form-group">
                            ...
                            <input name="email" type="email" id="email" class="form-control" placeholder="Enter your college email" required>
                            <div class="email-domain-note">
                                <i class="fas fa-info-circle"></i> Only @piemr.edu.in email addresses are allowed for login.
                            </div>
                        </div>
                        ...
                        <button type="submit" class="btn btn-login-submit">Login to Account</button>
                    </form>
        ...
        <div class="container">
            <div class="footer-content">
                <div class="footer-column">
                    <h3>BloodBond</h3>
                    <p>Connecting PIEMR donar and recipients to ensure no one dies due to lack of blood.</p>
...
// PIEMR domain check
function validatePIEMREmail(email) {
    return email.endsWith("@piemr.edu.in");
}
</script>
